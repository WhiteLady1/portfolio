...
export const ProjectsCarousel: React.FC<ProjectsCarouselProps> = ({
  ...
  return (
    <ScrollShadow size={100} hideScrollBar>
      ...
      <ul>
        {items.map(item => (
          <li key={item.slug} className="relative pl-12 mb-6 before:block before:absolute before:top-5 before:left-4 before:bg-[--background-flag] before:w-[2px] before:h-full before:rounded-2xl">
            <span className="flex">
